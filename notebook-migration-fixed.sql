-- Create notebook table for creative ideas (CORRECTED VERSION)
...
-- Junction table for notebook entries and mediums (FIXED: using INTEGER for medium_id)
...
-- Junction table for notebook entries and genres (FIXED: using INTEGER for genre_id)
...
COMMENT ON TABLE notebook_mediums IS 'Links notebook entries to mediums (Film, TV, etc.) - uses INTEGER medium_id';
COMMENT ON TABLE notebook_genres IS 'Links notebook entries to genres (Drama, Comedy, etc.) - uses INTEGER genre_id';
